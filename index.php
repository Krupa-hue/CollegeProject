  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top" style="height:70px">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse bg-dark text-light" id="navbarSupportedContent">
        ...
        <button class="btn btn-outline-info my-2 mx-1"><a href="login.php" class="text-decoration-none text-white">Log in</a></button>
        <button class="btn btn-outline-info my-2 mx-1"><a href="adlogin.php" class="text-decoration-none text-white">Admin</a></button>
      </div>
    </div>
  </nav>
